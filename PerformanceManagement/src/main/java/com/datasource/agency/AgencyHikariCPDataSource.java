 ...
 * @author rkipkirui
 */
public class AgencyHikariCPDataSource {

    static final String DATABASE_IP = EntryPoint.AGENCY_DATABASE_IP;
    static final String DATABASE_PORT = EntryPoint.AGENCY_DATABASE_PORT;
    static final String DATABASE_NAME = EntryPoint.AGENCY_DATABASE_NAME;
    static final String DATABASE_SERVER_TIME_ZONE = "";
    static final String DATABASE_USER = EntryPoint.AGENCY_DATABASE_USER;
    static final String DATABASE_PASSWORD = EntryPoint.AGENCY_DATABASE_PASSWORD;
    ...
    private AgencyHikariCPDataSource() {
    }
}
