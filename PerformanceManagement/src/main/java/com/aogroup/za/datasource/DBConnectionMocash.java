 ...
 * @author rkipkirui
 */
public final class DBConnectionMocash {

    String MOCASH_DATABASE_IP = "";
    String DATABASE_PORT = "";
    String MOCASH_DATABASE_NAME = "";
    ...
    public DBConnectionMocash() {
        logger = new Logging();
        stmt = null;
        rs = null;
        url = "jdbc:sqlserver://" + MOCASH_DATABASE_IP + ":" + DATABASE_PORT + ";DatabaseName=" + MOCASH_DATABASE_NAME + ";encrypt=false; trustServerCertificate=false;";
    }

    public Connection getConnection() {
        try {
            con = HikariCPDataSourceMocash.getConnection();
