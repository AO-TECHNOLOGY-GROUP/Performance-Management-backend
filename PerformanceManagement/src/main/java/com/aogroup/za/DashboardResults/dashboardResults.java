...
//            "            WHEN s.Frequency = 'Weekly' THEN et.Target / 5 " +
//            "            WHEN s.Frequency = 'Monthly' THEN et.Target / 22 " +
//            "            WHEN s.Frequency = 'Quarterly' THEN et.Target / 66 " +
//            "            ELSE 0 " +
//            "        END AS DailyExpectedTarget, " +
//            "        CASE " +
//            "            WHEN s.Frequency = 'Daily' THEN et.Target * 5 " +
//            "            WHEN s.Frequency = 'Weekly' THEN et.Target " +
//            "            WHEN s.Frequency = 'Monthly' THEN et.Target / 4.3 " +
//            "            WHEN s.Frequency = 'Quarterly' THEN et.Target / 13 " +
//            "            ELSE 0 " +
...
//                }
//
//                 // Calculate **Quarterly** Objective Percentage
//                String quarterlyObjectivePercentage = (totalExpectedQuarterly != 0) ? 
//                    String.format("%.2f", (totalAchievedQuarterly / totalExpectedQuarterly) * 100) : "0.00";
//
//                // Calculate **Daily** Objective Percentage
//                String dailyObjectivePercentage = (totalExpectedDaily != 0) ? 
//                    String.format("%.2f", (totalAchievedDaily / totalExpectedDaily) * 100) : "0.00";
//
